...
# --- 封面图设置  ---
cover:
    image: "G8y8l1PXwAA1hg0.jpg" # 图片文件名（确保图片就在同一个文件夹下）
    alt: "这是封面图描述"        # 辅助文字
    caption: "Steam, Steel, and Infinite Minds"      # 图片下方的说明
    relative: true              # 重要：设为 true 才会从当前文件夹查找图片
# --- 分类与标签 ---
categories:
    - "技术"
tags:
    ...
    - "AI"
# --- SEO 与显示控制 ---
description: "这篇文章介绍了Ai的方向" # 摘要/描述
